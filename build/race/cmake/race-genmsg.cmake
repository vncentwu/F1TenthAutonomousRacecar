...
message(STATUS "race: 2 messages, 0 services")

set(MSG_I_FLAGS "-Irace:/home/yipu/catkin_ws/src/race/msg;-Istd_msgs:/opt/ros/indigo/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/yipu/catkin_ws/src/race/msg/drive_param.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/yipu/catkin_ws/src/race/msg/drive_param.msg" ""
)

get_filename_component(_filename "/home/yipu/catkin_ws/src/race/msg/drive_values.msg" NAME_WE)
add_custom_target(_race_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "race" "/home/yipu/catkin_ws/src/race/msg/drive_values.msg" ""
)
...
_generate_msg_cpp(race
  "/home/yipu/catkin_ws/src/race/msg/drive_values.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/race
)
_generate_msg_cpp(race
  "/home/yipu/catkin_ws/src/race/msg/drive_param.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/race
)
