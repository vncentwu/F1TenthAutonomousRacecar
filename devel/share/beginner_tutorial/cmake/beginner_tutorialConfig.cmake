...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorial_SOURCE_PREFIX /home/yipu/catkin_ws/src/beginner_tutorial)
  set(beginner_tutorial_DEVEL_PREFIX /home/yipu/catkin_ws/devel)
  ...
  set(beginner_tutorial_INSTALL_PREFIX /home/yipu/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${beginner_tutorial_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yipu <yipu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yipu/catkin_ws/src/beginner_tutorial/${idir}'.  Ask the maintainer 'yipu <yipu@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yipu/catkin_ws/devel/lib;/home/yipu/catkin_ws/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  _pack_libraries_with_build_configuration(beginner_tutorial_LIBRARIES ${beginner_tutorial_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${beginner_tutorial_dep}_LIBRARIES})
  _list_append_deduplicate(beginner_tutorial_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(beginner_tutorial_LIBRARIES ${beginner_tutorial_LIBRARIES})
